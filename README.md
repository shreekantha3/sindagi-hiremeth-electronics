# Hiremeth Electronics — Website (Sindagi)

- **Live:** https://shreekantha3.github.io/sindagi-hiremeth-electronics/
- **Repo:** `shreekantha3/sindagi-hiremeth-electronics` (branch `main` = source, `gh-pages` = deployed bundle where applicable)
- **Stack:** static Vite + Tailwind CSS, no backend. `base: '/sindagi-hiremeth-electronics/'` for GitHub Pages project-site hosting.
